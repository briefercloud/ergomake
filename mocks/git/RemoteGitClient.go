...
// DoesBranchExist provides a mock function with given fields: ctx, owner, repo, branch, isPublic
func (_m *RemoteGitClient) DoesBranchExist(ctx context.Context, owner string, repo string, branch string, isPublic bool) (bool, error) {
	ret := _m.Called(ctx, owner, repo, branch, isPublic)

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, bool) (bool, error)); ok {
		return rf(ctx, owner, repo, branch, isPublic)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, bool) bool); ok {
		r0 = rf(ctx, owner, repo, branch, isPublic)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string, string, bool) error); ok {
		r1 = rf(ctx, owner, repo, branch, isPublic)
	} else {
		r1 = ret.Error(1)
	}
...
//   - branch string
//   - isPublic bool
func (_e *RemoteGitClient_Expecter) DoesBranchExist(ctx interface{}, owner interface{}, repo interface{}, branch interface{}, isPublic interface{}) *RemoteGitClient_DoesBranchExist_Call {
	return &RemoteGitClient_DoesBranchExist_Call{Call: _e.mock.On("DoesBranchExist", ctx, owner, repo, branch, isPublic)}
}

func (_c *RemoteGitClient_DoesBranchExist_Call) Run(run func(ctx context.Context, owner string, repo string, branch string, isPublic bool)) *RemoteGitClient_DoesBranchExist_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RemoteGitClient_DoesBranchExist_Call) RunAndReturn(run func(context.Context, string, string, string, bool) (bool, error)) *RemoteGitClient_DoesBranchExist_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetDefaultBranch provides a mock function with given fields: ctx, owner, repo, isPublic
func (_m *RemoteGitClient) GetDefaultBranch(ctx context.Context, owner string, repo string, isPublic bool) (string, error) {
	ret := _m.Called(ctx, owner, repo, isPublic)

	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, bool) (string, error)); ok {
		return rf(ctx, owner, repo, isPublic)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, bool) string); ok {
		r0 = rf(ctx, owner, repo, isPublic)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string, bool) error); ok {
		r1 = rf(ctx, owner, repo, isPublic)
	} else {
		r1 = ret.Error(1)
	}
...
//   - repo string
//   - isPublic bool
func (_e *RemoteGitClient_Expecter) GetDefaultBranch(ctx interface{}, owner interface{}, repo interface{}, isPublic interface{}) *RemoteGitClient_GetDefaultBranch_Call {
	return &RemoteGitClient_GetDefaultBranch_Call{Call: _e.mock.On("GetDefaultBranch", ctx, owner, repo, isPublic)}
}

func (_c *RemoteGitClient_GetDefaultBranch_Call) Run(run func(ctx context.Context, owner string, repo string, isPublic bool)) *RemoteGitClient_GetDefaultBranch_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RemoteGitClient_GetDefaultBranch_Call) RunAndReturn(run func(context.Context, string, string, bool) (string, error)) *RemoteGitClient_GetDefaultBranch_Call {
	_c.Call.Return(run)
	return _c
}
